  ...
  <div class="product-display">
    <table class="product-display-table order-table">
      ...
      <?php
        ...
        $query = "SELECT * FROM orders WHERE orderStatus = 'Delivered' ORDER BY order_reference_number";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($rows = $result->fetch_assoc()) {
                ...
                if ($orderId !== $currentOrderId) {
                    ...
                    echo '</select>';
                    echo '<button type="submit" class="save-btn" onclick="submitForm(' . $orderId . ')">Save</button>';
                    echo '</form>';
                    echo '</td></tr>';
                } else {
                    $rowClass = $isEven ? 'even' : 'odd';
