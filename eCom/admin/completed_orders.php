...
<section>
  ...
  <ul id="ordernavbar">
      ...
      <li><a class="active" href="completed_orders.php">Completed</a></li>
  ...
  <div class="product-display">
    <table class="product-display-table order-table">
      ...
      <?php
        ...
        $query = "SELECT * FROM orders WHERE orderStatus = 'Completed' AND payment_status = 'Completed' ORDER BY order_reference_number";
