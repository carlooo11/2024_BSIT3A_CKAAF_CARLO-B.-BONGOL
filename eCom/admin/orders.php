...
<section>
  <div class="myordersnav">
    <ul id="ordernavbar">
    <li><a class="active" href="orders.php">Pending</a></li>
        ...
        if ($result->num_rows > 0) {
          ...
          while ($rows = $result->fetch_assoc()) {
            ...
            if ($orderId !== $currentOrderId) {
               ...
               echo '<form id="orderForm' . $orderId . '" class="orderForm" action="../update_order_status.php" method="post">';
               echo '<input type="hidden" name="orderId" value="' . $orderId . '">';
               echo '<select class="statbtn" name="orderStatus" id="orderStatus' . $orderId . '">';
               ...
               echo '</select>';
               echo '<button type="button" class="save-btn">Save</button>';
               echo '</form>';
               echo '</td></tr>';
           } else {
               $rowClass = $isEven ? 'even' : 'odd';
