...
<body>
    ...
    <div class="myordersnav">
        <ul id="ordernavbar">
            ...
            <li><a class="active" href="myOrders_shipped.php">Shipped</a></li>
    ...
    <form action="../request/cancel_order_request.php" method="post">
        <table width="100%">
            ...
            <tbody>
                ...
                $sql_fetch_shipped_orders = "SELECT * FROM orders WHERE orderStatus = 'shipped' ORDER BY order_reference_number";
